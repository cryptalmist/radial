...
public class RadialConfigScreen {
    ...
    public static Screen create(Screen parent) {
        ...
        return YetAnotherConfigLib.createBuilder()
                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .tooltip(Text.translatable("screen.radial.config.category.settings.tooltip"))
                        ...
                        .option(Option.<Boolean>createBuilder()
                                .name(Text.empty())
                                .binding(false, () -> false, unused -> {})
                                .customController(opt -> createPreviewController(opt, config))
                                .build())

                        // LAYOUT
                        .group(OptionGroup.createBuilder()
                                .name(Text.translatable("screen.radial.config.group.layout"))
                                .option(Option.<Integer>createBuilder()
                                        .name(Text.translatable("screen.radial.config.slot_count"))
                                        .description(OptionDescription.of(
                                                Text.translatable("screen.radial.config.slot_count.tooltip")))
                                        ...
                                        .build())
                                .option(Option.<Integer>createBuilder()
                                        .name(Text.translatable("screen.radial.config.slot_radius"))
                                        .description(OptionDescription.of(
                                                Text.translatable("screen.radial.config.slot_radius.tooltip")))
                                        ...
                                        .build())
                                .option(Option.<Integer>createBuilder()
                                        .name(Text.translatable("screen.radial.config.radial_thickness"))
                                        .description(OptionDescription.of(
                                                Text.translatable("screen.radial.config.radial_thickness.tooltip")))
                                        ...
                                        .build())
                                .option(Option.<Integer>createBuilder()
                                        .name(Text.translatable("screen.radial.config.inner_detection_boundary"))
                                        ...
                                        .build())
                                .option(Option.<Integer>createBuilder()
                                        .name(Text.translatable("screen.radial.config.outer_detection_boundary"))
                                        .description(OptionDescription.of(Text.translatable(
                        ...
                        // APPEARANCE
                        .group(OptionGroup.createBuilder()
                                .name(Text.translatable("screen.radial.config.group.appearance"))
                                .option(Option.<Color>createBuilder()
                                        .name(Text.translatable("screen.radial.config.background_color"))
                                        .description(OptionDescription.of(
                                                Text.translatable("screen.radial.config.background_color.tooltip")))
                                        .binding(
                                        ...
                                        .build())
                                .option(Option.<Color>createBuilder()
                                        .name(Text.translatable("screen.radial.config.activation_color"))
                                        .description(OptionDescription.of(
                                                Text.translatable("screen.radial.config.activation_color.tooltip")))
                                        .binding(
                                        ...
                                        .build())
                                .option(Option.<Color>createBuilder()
                                        .name(Text.translatable("screen.radial.config.border_color"))
                                        .description(OptionDescription.of(
                                                Text.translatable("screen.radial.config.border_color.tooltip")))
                                        .binding(
                                        ...
                                        .build())
                                .option(Option.<Color>createBuilder()
                                        .name(Text.translatable("screen.radial.config.highlight_border_color"))
                                        .description(OptionDescription.of(Text.translatable(
                                        ...
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.translatable("screen.radial.config.show_activation_zone"))
                                        .description(OptionDescription.of(
                                                Text.translatable("screen.radial.config.show_activation_zone.tooltip")))
                                        .binding(
                                                true,
                                        ...
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.translatable("screen.radial.config.draw_outer_borders"))
                                        .description(OptionDescription.of(
                                                Text.translatable("screen.radial.config.draw_outer_borders.tooltip")))
                                        .binding(true, () -> config.drawOuterBorders, v -> config.drawOuterBorders = v)
                                        .controller(BooleanControllerBuilder::create)
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.translatable("screen.radial.config.draw_sector_borders"))
                                        .description(OptionDescription.of(
                                                Text.translatable("screen.radial.config.draw_sector_borders.tooltip")))
                                        .binding(
                                                true, () -> config.drawSectorBorders, v -> config.drawSectorBorders = v)
                                        .controller(BooleanControllerBuilder::create)
                                        .build())
                                .option(Option.<Float>createBuilder()
                                        .name(Text.translatable("screen.radial.config.sector_border_width"))
                                        .description(OptionDescription.of(
                                                Text.translatable("screen.radial.config.sector_border_width.tooltip")))
                                        .binding(
                                        ...
                                        .build())
                                .option(Option.<Float>createBuilder()
                                        .name(Text.translatable("screen.radial.config.sector_gap"))
                                        .description(OptionDescription.of(
                                                Text.translatable("screen.radial.config.sector_gap.tooltip")))
                        ...
                        // BEHAVIOR
                        .group(OptionGroup.createBuilder()
                                .name(Text.translatable("screen.radial.config.group.behavior"))
                                .option(Option.<RadialConfig.RevealAnimation>createBuilder()
                                        .name(Text.translatable("screen.radial.config.reveal_animation"))
                                        .description(OptionDescription.of(
                                                Text.translatable("screen.radial.config.reveal_animation.tooltip")))
                                        .binding(
                                        ...
                                        .build())
                                .option(Option.<Integer>createBuilder()
                                        .name(Text.translatable("screen.radial.config.reveal_duration_ms"))
                                        .description(OptionDescription.of(
                                                Text.translatable("screen.radial.config.reveal_duration_ms.tooltip")))
                                        ...
                                        .build())
                                .option(Option.<Boolean>createBuilder()
                                        .name(Text.translatable("screen.radial.config.enable_hover_animation"))
                                        .description(OptionDescription.of(Text.translatable(
                                        ...
                                        .build())
                                .option(Option.<Integer>createBuilder()
                                        .name(Text.translatable("screen.radial.config.hover_animation_duration_ms"))
                                        .description(OptionDescription.of(Text.translatable(
                                ...
                                .option(Option.<RadialConfig.ActivationMode>createBuilder()
                                        .name(Text.translatable("screen.radial.config.activation_mode"))
                                        .description(OptionDescription.of(
                                                Text.translatable("screen.radial.config.activation_mode.tooltip")))
                                        .binding(
                ...
                // LIVE PREVIEW
                .category(ConfigCategory.createBuilder()
                        .name(Text.translatable("screen.radial.config.category.preview"))
                        .option(Option.<Boolean>createBuilder()
                                .name(Text.empty())
                                .binding(false, () -> false, unused -> {})
                                .customController(opt -> createPreviewController(opt, config))
     ...
     */
    private static void drawAnnulus(DrawContext graphics, float cx, float cy, float innerRadius, float outerRadius) {
     ...
     * Preview rendering
     */
    private static void renderPreview(DrawContext graphics, RadialConfig config) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            graphics.getMatrices().scale(hoverScale, hoverScale);
